        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('updateProfile', ['id' => $user->id]) }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control js-datepicker" name="birthday" value="{{ date('Y-m-d', \Carbon\Carbon::parse($user->birthday)->timestamp) }}" required>
